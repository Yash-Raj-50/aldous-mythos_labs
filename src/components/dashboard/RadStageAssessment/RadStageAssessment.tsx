      ...
      <div className="flex flex-col items-center justify-around grow w-full gap-2 py-2">
        <div className="w-full flex flex-row items-center justify-around gap-0">
          <div className="h-16 basis-1/4 bg-[#5790C1] flex flex-col items-center justify-center rounded-full">
            {data.stage.toLowerCase()==="curiosity" && <div className="bg-white font-bold h-16 w-16 flex flex-col items-center justify-center rounded-full border-4 border-[#C26166]">HERE</div>}
          </div>
          <div className="h-16 basis-1/4 bg-[#3A70AF] flex flex-col items-center justify-center">
            {data.stage.toLowerCase()==="sympathy" && <div className="bg-white font-bold h-16 w-16 flex flex-col items-center justify-center rounded-full border-4 border-[#C26166]">HERE</div>}
          </div>
          <div className="h-16 basis-1/4 bg-[#235197] flex flex-col items-center justify-center">
            {data.stage.toLowerCase()==="action-seeking" && <div className="bg-white font-bold h-16 w-16 flex flex-col items-center justify-center rounded-full border-4 border-[#C26166]">HERE</div>}
          </div>
          <div className="h-16 basis-1/4 bg-[#142F66] flex flex-col items-center justify-center rounded-full">
            {data.stage.toLowerCase()==="operational" && <div className="bg-white font-bold h-16 w-16 flex flex-col items-center justify-center rounded-full border-4 border-[#C26166]">HERE</div>}
          </div>
        </div>
